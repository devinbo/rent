...
public class UmsMemberLink implements Serializable {
    private Long id;

    @ApiModelProperty(value = "常用联系人姓名1")
    private String name1;

    @ApiModelProperty(value = "常用联系人性别 0->未知 ，1->男，2->女")
    ...
    @ApiModelProperty(value = "联系人备注1")
    private String note1;

    @ApiModelProperty(value = "联系人备注2")
