...
public class OtoOrderPayment implements Serializable {
    private Long id;
    ...
    @ApiModelProperty(value = "是否支付给租方：0->尚未支付 1->已支付")
    private Integer payOutStatus;

    @ApiModelProperty(value = "支付给租方金额")
    private BigDecimal payOutMoney;

    @ApiModelProperty(value = "支付给租方时间")
    ...
    public String toString() {
        ...
        sb.append(", payOutStatus=").append(payOutStatus);
        sb.append(", payOutMoney=").append(payOutMoney);
        sb.append(", payOutTime=").append(payOutTime);
