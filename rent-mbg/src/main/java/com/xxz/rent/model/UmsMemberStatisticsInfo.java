...
public class UmsMemberStatisticsInfo implements Serializable {
    ...
    private Integer browseProductCount;

    @ApiModelProperty(value = "收藏产品数量")
    private Integer collectProductCount;

    @ApiModelProperty(value = "最后一次签约订单时间（自营平台）")
    private Date recentOrderSelfTime;

    @ApiModelProperty(value = "最后一次签约订单时间（三方）")
    ...
    public Integer getBrowseProductCount() {
        return browseProductCount;
    }

    public void setBrowseProductCount(Integer browseProductCount) {
    ...
    public Date getRecentOrderSelfTime() {
        return recentOrderSelfTime;
    }

    public void setRecentOrderSelfTime(Date recentOrderSelfTime) {
        this.recentOrderSelfTime = recentOrderSelfTime;
    }
    ...
    public String toString() {
        ...
        sb.append(", browseProductCount=").append(browseProductCount);
        sb.append(", collectProductCount=").append(collectProductCount);
        sb.append(", recentOrderSelfTime=").append(recentOrderSelfTime);
