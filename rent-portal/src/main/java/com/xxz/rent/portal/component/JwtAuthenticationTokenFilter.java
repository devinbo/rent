    ...
    protected void doFilterInternal(HttpServletRequest request,
        ...
        if (authHeader != null && authHeader.startsWith(this.tokenHead)) {
            ...
            if (telephone != null && SecurityContextHolder.getContext().getAuthentication() == null) {
                MemberDetails memberDetails = this.smsMemberService.getUser(telephone);
                if (jwtTokenUtil.validateToken(authToken, memberDetails)) {
                    ...
                    LOGGER.info("authenticated telephone:{}", telephone);
                }
            }
        }
