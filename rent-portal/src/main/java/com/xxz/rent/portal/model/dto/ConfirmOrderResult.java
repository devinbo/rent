...
import com.xxz.rent.model.UmsIntegrationConsumeSetting;
...
public class ConfirmOrderResult {
    //包含优惠信息的购物车信息
    private List<com.xxz.rent.portal.model.dto.CartPromotionItem> cartPromotionItemList;
    //用户收货地址列表
    private List<UmsMemberReceiveAddress> memberReceiveAddressList;
    //用户可用优惠券列表
    private List<com.xxz.rent.portal.model.dto.SmsCouponHistoryDetail> couponHistoryDetailList;
    //积分使用规则
    ...
    public List<com.xxz.rent.portal.model.dto.CartPromotionItem> getCartPromotionItemList() {
        return cartPromotionItemList;
    }

    public void setCartPromotionItemList(List<com.xxz.rent.portal.model.dto.CartPromotionItem> cartPromotionItemList) {
    ...
    public List<com.xxz.rent.portal.model.dto.SmsCouponHistoryDetail> getCouponHistoryDetailList() {
        return couponHistoryDetailList;
    }

    public void setCouponHistoryDetailList(List<com.xxz.rent.portal.model.dto.SmsCouponHistoryDetail> couponHistoryDetailList) {
